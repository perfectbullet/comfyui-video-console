<template>
  <div class="app">
    <header><div><small>COMFYUI · CS-H3</small><h1>系统信息</h1><p>查看 ComfyUI 运行状态与显存占用，并手动释放显存（卸载模型 + 清空缓存）。</p></div><nav><a href="/?mode=storyboard">九宫格分镜生成</a><a href="/?mode=i2v">I2V 首帧生视频</a><a href="/?mode=director">多模式导演台</a><a href="/?mode=nine-images">九图分镜版</a><a class="active" href="/?mode=system">系统信息</a></nav></header>
    <main class="layout">
